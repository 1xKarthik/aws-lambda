            ...
            if 'Name' in tag['Key']:
                ...
                for instance_id, instance in ec2info.items():  # loop through the instances
                    ...
                    cw.put_metric_alarm(
                        ...
                        # provide actions to take if this alarm triggers (like creating new ec2 instance/ sending email)
                        MetricName='CPUUtilization',
                        # Metric Name like (NetworkOut, DiskWriteOps, StatusCheckFailed_Instance, StatusCheckFailed_System)
                        ...
                        # ID's for the metric specified in MetricName
                        Period=300,
